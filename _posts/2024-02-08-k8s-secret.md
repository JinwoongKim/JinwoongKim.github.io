  ...
  managedFields:
    - manager: kubectl-create
      ...
      fieldsV1:
        ...
        f:type: {}
data:
  git_token: Z2hwX2JBRjlyWGNScll4OTZkcFlUNEM2M1lYeFIyMTVTMDRmVE56Yw==
  slack_token: eG94Yi0xMjUyNDAwOTY2Njg4LTYxOTYyMDUwOTcyMzUtM3FPeEZNaDd3ZTJOZ2VmODluTHlST3ps
type: Opaque
```
