...
물론  teach, mentor, guide, direct team, risk mangement, priority, roadmap 등이나 고도의 도메인 지식, database architecture, hardware and scalability 등등을 시니어가 갖출 역량이라고 생각한다. 아무리 도메인 지식이 많더라도, 위와 같은 능력을 갖추지 않으면 시니어로 넘어가기 어렵다고 생각한다.
