...
충분히 납득할 만한 내용이라고 생각한다. 그리고 내가 아는 빅테크기업(구글, 애플, 메타,아마존 등)들이 이런 식으로 분류를 하고 있기도 하다. 여기선 teach, mentor, guide, direct team, risk mangement, priority, roadmap 등의 스킬과 고도의 도메인 지식, database architecture, hardware and scalability 등등을 시니어가 갖출 역량이라고 생각한다. 아무리 도메인 지식이 많더라도, 위와 같은 능력을 갖추지 않으면 시니어로 넘어가기 어렵다고 생각한다.
