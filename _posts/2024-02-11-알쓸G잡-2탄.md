...
- Micro-architecture : GPU의 근간이 되는 아키텍쳐 이름이다. 같은 아키텍쳐에서 여러 CC 가 있을 수 있다.
	- Ampere 아키텍쳐에서 A100은 CC가 8.0이고 A40은 8.6이다. 그렇다고 아키텍쳐가 변한다고 CC가 1씩 올라가는 것도 아니다. Volta는 7.0~7.2였고 Turing은 7.5였다. 그리고 CC가 더 높다고 무조건 좋은 건 아니다. 하지만 일반적으로 CC가 높으면 지원하는 기능들이 더 많다.
