...
사실 대부분의 신입사원들은 여기서 업무 정의가 그치게 될 것이다. 하지만 조금만 더 나아간다면, `왜 NAS를 A 서버에 설치`하라고 했지?라고 의문을 품게 될 것이다. 여기서 나오게 되는 개념이 `WWH` 이다. WWH는 Why, What, How 의 줄임말이고 내가 방금 줄였다. 하하하
