...
사실 보다 큰 문제는, 이러한 사람들이 경력을 쌓고 높은 위치에 올라갔을때, `WHAT`은 커녕 `WHY`나 `ROOT CAUSE`를 인지조차 못해 파악조차 하지 않으려고 하는 경우가 있다는 것이다. 그렇게 되면 일은 어마어마하게 많이 하는데 산출물이나 결과물은 나오지 않고, '난 열심히 했는데 운이 안 좋네~', '회사가 문제네~', '상사가 문제네~'이렇게 말하게 될 수 있는 것이다.
