...
## 문제
- 트랜스포머 기반 LLM 모델의 경우 문자열의 길이가 매우 제한적입니다.
- 여러 가지 환경 때문에늘리는게 어렵습니다.
	- GPT3, Gemini 등 트랜스포머 기반 모델 모두 제한된 입력 길이를 갖고 있습니다.
- 또한 이러한 문제를 해소 할 수 있는 방법 중 하나인 approximate attention methods의 경우 잠재적인 문제를 야기 할 수 있다고 지적하고 있다.
## 원인
