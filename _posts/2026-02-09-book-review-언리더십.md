...
- 정보를 권력으로 쓰지 마라, 모든 정보를 공개하라
   ...
   - 정보는 말초신경까지 잘 가야 제대로 가치를 가진다. 실무자가 정보를 가져야 제대로 판단할 수 있다. 보고서 만들면서 정보가 가공되면 위에 있는 사람이 오히려 제대로 판단을 못한다.
   - 규칙 없음에서도 비슷한 얘기를 하지만, 여기선 더 심하다. 월급까지 공개하라고 한다. 토스에서는 월급 빼고 다 공개한다고 하는데, 솔직히 요즘엔 그것도 좀 아닌 것 같고.
- "정보 통제해야 한다"는 3가지 핑계를 믿지 마라
   - 첫째, "정보 홍수에서 직원들이 혼란스러울 것이다" → 사람들은 적응한다. 하다 보면 필요한 정보를 충분히 걸러낸다. (근데 멀티태스킹은 안 된다는 연구도 많아서 좀 갸우뚱. 나도 요즘 정보 과부하로 힘들어하고 있다.)
   - 둘째, "기밀정보를 팔아넘길 것이다" → 팔아넘길 놈은 어떻게든 팔아넘긴다. 98%가 신뢰할 가치가 있는데 2% 때문에 98%를 포기하는 건 옳지 않다. (근데 우리 회사 업무폰 도입하는 거 보면 이 원칙 아닌가 봄.)
...
- 보고서 쓰지 마라, 실무자가 직접 판단하게 하라
   ...
   - 투명성은 이상적인 통제 메커니즘이다. 족벌 경영, 부패, 절도, 수치 조작을 예방하고, 근로자들이 기업가처럼 행동하게 만든다.
- (내 생각) 맞는 말이지만 쉽지 않다
   - 규칙 없음에서는 단순히 정보 공개하라고 안 하고, 먼저 인재 밀도를 올리라고 한다. 여기선 그런 내용이 빠져서 오히려 규칙 없음이 더 현실적으로 느껴졌다.
   - 신뢰 아니면 불신이라는 태도는 별로다. 신뢰하면서도 동시에 냉정하게 바라보라고 하는데, 이게 말이 쉽지.
   - 전반적으로 맞는 말이지만, "이렇게 해라" 하면 보통이 아니다. 연봉까지 공개하라니.
