...
시크릿에 모든 value 는 base64로 인코딩 되어야 한다. 나는 bash가 매우 익숙한 사람인데, 리눅스/맥 터미널에 아래 코드를 이용하면 쉽게 인코딩 할 수 있다. (윈도우는 파워쉘로 하면 될 것 같고 구글링 해보면 온라인에서 해주는 곳도 많다)
...
이렇게 시크릿에 넣을 값들을 base64 로 인코딩해주고 
### 어떻게 사용하는가?
