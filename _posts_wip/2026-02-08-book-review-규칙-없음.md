...
- 규정을 추가하면 경영진에게 업무를 장악하고 있다는 기분은 주지만, 실제로는 일의 속도만 떨어진다.
- 하지만 통제를 없애도 사람들이 잘 안 쓰는 경우가 있다. 그래서 리더가 먼저 모범을 보여야 한다고 한다. 일을 시킬 때도 마이크로매니징하지 말고, 맥락을 전달하고 이해가 안 되면 맥락을 보강하라고.
