...
회사 대표님이 추천해줘서 사놨다가, 갑자기 눈에 띄어서 읽은 책이다. 최근에 규칙 없음(No Rules Rules)을 정리하고 다시 보니, 정말 비슷한 부분이 많았다. 거의 20년 전에 나온 책인데 대단하다.

전통적인 위계 조직(알파 기업)을 비판하고, 자율적으로 움직이는 조직(베타 기업)을 대안으로 제시하는 책이다. 솔직히 규칙 없음보다는 좀 더 이상주의적이다. 주장 자체는 공감 가는 부분이 많은데, 현실에서 그대로 적용하기엔 거리가 있는 이야기도 꽤 있다. 그래도 조직을 어떻게 운영해야 하는지에 대해 생각할 거리를 많이 던져주는 책이다.
...
- 특히 비용 절감 이야기가 공감이 많이 갔다. 비용 절감은 경영자가 할 수 있는 게 아니라, 실제 프로세스에 참여한 사람들이 디테일하게 들여다봐야 나온다고 한다. 단순히 근로자를 해고하는 건 단기적인 거고, 오히려 장기적으로는 잠재력이 사라진다. 바깥에서는 본질적인 비용 절감을 할 수 없다는 말이 정말 맞는 것 같다.
...
- 여기서 정말 뒤통수를 맞은 질문이 있다. "판매 부서가 매출을 10% 더 올린다고 해서 고객에게 무슨 이득이 있을까?" 회사에 이익을 갖다 주는 게 목적이 아니라, 결국 고객에게 이익을 갖다 주는 것이 중요하다는 얘기였다. 물론 회사가 돈을 벌어야 서비스를 계속 제공할 수 있으니 둘이 분리된 건 아니지만, 매출 자체가 목적이 되면 안 된다는 건 맞는 것 같다.
- 그래서 성과나 OKR의 지표 자체가 시장과 연결되어야 하지 않을까 하는 생각을 많이 했다.
- 알파 기업에서는 자기 배꼽이나 바라보는 내부 행정 업무가 90%라고 풍자하고 있다. 베타 기업은 그런 업무가 20~30% 정도이고, 나머지는 고객이 만족할 만한 일을 한다고.
- 재밌는 진단법도 나온다. 사무실 벽에 걸린 게 설계도, 수치, 고객 주문서 같은 것이면 고객 지향적인 회사고, 지위나 취향을 나타내는 것들이면 누군가를 위한 회사라는 거다.
...
- 읽으면서 든 생각: 우리 회사 컬처핏에서 내가 합격시킨 사람을 위에서 떨구는 경우가 너무 많은데, 이건 책에서 말하는 "팀이 동료를 뽑는다"와 정반대다. 그리고 필요한 업무에 사람을 뽑는다고 생각했는데, 좋은 사람을 먼저 뽑고 업무를 확장한다는 발상이 신기했다.
